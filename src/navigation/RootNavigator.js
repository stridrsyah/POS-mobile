/**
 * src/navigation/RootNavigator.js — Navigasi Root Aplikasi
 */
            ...
            return (
              <TouchableOpacity key={route.key} onPress={onPress} style={S.posOuter} activeOpacity={0.85}>
                <View style={[S.posCircle, focused && S.posCircleActive]}>
                  ...
                  {totalItems > 0 && (
                    <View style={S.badge}>
                      <Text style={S.badgeTxt}>{totalItems > 9 ? '9+' : totalItems}</Text>
                    </View>
                  )}
                </View>
...
const S = StyleSheet.create({
  ...
  bar: {
    flexDirection: 'row', backgroundColor: COLORS.bgMedium,
  ...
  posCircle: {
    ...
    shadowOffset: { width: 0, height: 5 }, shadowOpacity: 0.5, shadowRadius: 10,
    borderWidth: 3, borderColor: COLORS.bgMedium,
  },
